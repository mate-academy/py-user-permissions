...
class ActorViewSet(ListCreateGenericViewSet):
    queryset = Actor.objects.all()
    serializer_class = ActorSerializer


class CinemaHallViewSet(ListCreateGenericViewSet):
    queryset = CinemaHall.objects.all()
    serializer_class = CinemaHallSerializer


class MovieViewSet(ListCreateGenericViewSet, mixins.RetrieveModelMixin):
